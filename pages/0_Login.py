...
# --- PAGE CONFIGURATION ---
st.set_page_config(
    page_title="Welcome - AI Learning Agent",
    page_icon="🤖",
    layout="wide",
...
with left_col:
    st.markdown(
        "<h1 style='font-weight: 700;'>Personal AI Learning Assistant</h1>",
        unsafe_allow_html=True,
    )
    st.markdown(
        "<p style='font-size: 1.1rem; opacity: 0.9;'>Unlock your potential with a learning experience tailored just for you. Our intelligent assistant adapts to your skill level, guides you through complex topics, and helps you master any subject.</p>",
        unsafe_allow_html=True,
    )
    st.markdown("<hr style='opacity: 0.3;'>", unsafe_allow_html=True)
    st.markdown(
        """
        <ul style='font-size: 1.1rem; opacity: 0.9; list-style-type: "✅ "; padding-left: 20px;'>
...
with right_col:
    ...
    if st.session_state.form_view == "login":
        ...
        with col_text:
            st.markdown(
                "<p style='text-align: right; margin-top: 10px; opacity: 0.8;'>Don't have an account?</p>",
                unsafe_allow_html=True,
            )
        with col_btn:
    ...
    # --- SIGNUP VIEW ---
        ...
        with col_text:
            st.markdown(
                "<p style='text-align: right; margin-top: 10px; opacity: 0.8;'>Already have an account?</p>",
                unsafe_allow_html=True,
            )
        with col_btn:
